      ...
      <>
         <div className={styles.reviewTitleFlex}>
            ...
            <h2 className="description">
               Ne pasă de clienții noștri, și apreciem o muncă de calitate, așa că... Lorem ipsum
               dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in hendrerit
               urna.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi.
            </h2>
         </div>
         <div className={styles.reviewContainer} style={{ height: "auto" }}>
            ...
            <CustomReview avatar={avatar2.src} name="Iosif Ștefan" value={4}>
               Nu știu ce mă făceam fără serviciile prestate de acest băiat. A reușit să ma salveze
               dintr-o situație inimaginabilă. Recomand!
            </CustomReview>
            <CustomReview avatar={avatar3.src} name="Mareș Gabriel" value={5}>
               Având în vedere că l-am sunat la 2 noaptea, a venit la sute de kilometri distanță ca
               să mă ajute. Nu știu ce mă faceam fără el. Sunați cu încredere!
            </CustomReview>
         </div>
      </>
   );
